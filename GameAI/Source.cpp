...
#include "Backgammon\BackgammonConstants.h"
...
int main(int argc, char* args[])
{
	...
	if(InitSDL())
	{
		...
		gameScreenManager = new GameScreenManager(gRenderer, SCREEN_BACKGAMMON);// SCREEN_CONWAY);// SCREEN_RAINBOWISLANDS);// SCREEN_LUNAR);//SCREEN_CHESS);
		...
		while(!quit)
		{
			...
			if (gameScreenManager->IsInScreen(SCREEN_CHESS) || gameScreenManager->IsInScreen(SCREEN_BACKGAMMON)) //DO NOT CHANGE
			{
...
{	
	...
	else
	{
		...
		gWindow = SDL_CreateWindow("Game AI", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, kBackgammonBoardWidth, kBackgammonBoardHeight, SDL_WINDOW_SHOWN);
